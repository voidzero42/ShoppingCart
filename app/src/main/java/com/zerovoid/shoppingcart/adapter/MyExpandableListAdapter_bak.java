 ...
 */
public class MyExpandableListAdapter_bak extends BaseExpandableListAdapter {
...
//    }
    public MyExpandableListAdapter_bak(Context context, List<ShoppingCartBean> listChild, List<String> listGroup, List<List<String>> listChild2) {
        mContext = context;
...
//                        int childPosition = Integer.parseInt(s[1]);
//                        ShoppingCartBiz.delGood(mListChild.get(groupPosition3).getGoods().get(childPosition).getProductID());
//                        listChild.get(groupPosition3).remove(childPosition);
//                        if (listChild.get(groupPosition3).size() == 0) {
//                            listChild.remove(groupPosition3);
